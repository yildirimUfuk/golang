...
func chanFunc(myChannel chan string) {
	fmt.Println("channelFunc executed!")
...
func channelsEx() {
	...
	fmt.Println("adress of myChannel:", myChannel) //addres of channel
	fmt.Println("waiting gor channels value!")
	fmt.Println("value of <-myChannel:", <-myChannel) //value of channel
